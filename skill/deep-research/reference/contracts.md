...
- Host independence: two sources count as independent when their registrable domains differ (compare `eTLD+1` approximated as last two labels, three for `co.uk`-style suffixes).
