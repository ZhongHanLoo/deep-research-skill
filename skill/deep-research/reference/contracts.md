...
- `gate`: `passed` | `failed:length` | `failed:block-page` | `failed:consent-wall` | `failed:js-empty` | `failed:unextracted-pdf` | `failed:word-list` | `failed:binary` | `failed:nav-only` | `not-run`
