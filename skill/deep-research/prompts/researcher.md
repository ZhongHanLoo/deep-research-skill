...
- **Specifications, standards, guidelines and regulator pages: extract every normative rule or recommendation in the sections you cite** (each MUST/SHOULD/grade/threshold as its own claim), not only the ones that match your hypothesis, and also the companion recommendations on the same page (what the body recommends *instead*, exclusions, effective dates). In the 2026-09-03 probe every missed rubric item was such an adjacent fact on a page that had been fetched.
